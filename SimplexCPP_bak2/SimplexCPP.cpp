...
int main()
{
    ...
    check(fraction(4,3), result.GetValue("x1"));
    check(fraction(4,3), result.GetValue("x2"));
    check(0,               result.GetValue("w1"));
    check(0,               result.GetValue("w2"));
    check(fraction(8,3),  result.GetValue("Pmax"));
